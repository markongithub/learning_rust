...
fn solve_for_n_rocks(input: &str, n_rocks: usize) -> usize {
    ...
    let mut next_jet = 0;
    for shape_id in 0..n_rocks {
        if shape_id > 0 && shape_id % 1000000 == 0 {
            println!("Now considering rock {}...", shape_id);
        }
...
fn solve_part2(input: &str) -> usize {
    solve_for_n_rocks(input, 1000000000000)
}
...
fn main() {
    ...
    //  println!("Part 2 test: {:?}", solve_part2(test_input));
}
